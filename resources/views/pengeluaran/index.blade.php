...
<nav class="w-full rounded-md flex flex-col md:flex-row items-center justify-between space-y-6 md:space-y-0 mb-4">
  ...
  <a href="{{ url('pengeluaran/create')}}" class="button medium blue flex justify-center items-center">
...
<div class="card has-table">
    <header class="card-header">
        ...
        <form action="{{ url('pengeluaran/') }}" method="get" class="card-header-title">
            @csrf
          ...
          <tr>
            ...
            <td class="actions-cell">
              <div class="buttons right nowrap">
                <a href="{{ url('pengeluaran/'.$item->no_kwitansi.'/'.'edit/')}}" class="button small blue" type="button">
              ...
              <div id="modal{{ $i }}" class="modal">
                ...
                <div class="modal-card">
                  ...
                  <footer class="modal-card-foot">
                    ...
                    <form class="d-inline" action="{{ url('pengeluaran/'.$item->no_kwitansi)}}" method="post">
                      @csrf 
                      @method('DELETE') 

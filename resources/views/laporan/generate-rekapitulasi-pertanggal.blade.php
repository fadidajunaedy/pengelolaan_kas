...
<body>
  <div class="container">
    ...
    <div class="content">
      <p>Berikut ini adalah laporan rekapitulasi kas koperasi untuk tanggal {{ \Carbon\Carbon::parse($dataPenerimaan[0]->tanggal)->translatedFormat('d F Y') }} :</p>
      <table class="blueTable">
        ...
        <tr>
          <td class="td-totalJumlah" colspan="3"><strong>TOTAL JUMLAH PENERIMAAN</strong></td>
        ...
        <tbody>
          ...
          <tr>
            <td class="td-totalJumlah" colspan="3"><strong>TOTAL JUMLAH PENGELUARAN</strong></td>

...
<body>
  <div class="container">
    <div class="header">
      ...
      <h2 style="line-height: 3px; margin-bottom: 24px;">PELAPORAN PENERIMAAN KAS</h2>
    </div>
    <div class="content">
      <p>Berikut ini adalah laporan penerimaan kas koperasi untuk bulan {{ \Carbon\Carbon::parse($data[0]->tanggal)->translatedFormat('F Y') }} :</p>
      ...
      <table class="blueTable">
        ...
        <tfoot>
            <tr>
                <td class="td-totalJumlah" colspan="4"><strong>TOTAL JUMLAH</strong></td>

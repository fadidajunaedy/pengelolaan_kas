...
<nav class="w-full rounded-md flex flex-col md:flex-row items-center justify-between space-y-6 md:space-y-0 mb-4">
    <ol class="list-reset flex">
        ...
        <li class="text-neutral-500 dark:text-neutral-400">Laporan Penerimaan</li>
    </ol>
</nav>
@include('components.notification')
<div class="card-content">
          <form id="form-get-by-tanggal" action="{{ url('/penerimaan-pertanggal-preview') }}" method="get">
            @csrf
        ...
        <hr>
        <form id="form-get-by-bulan" action="{{ url('/penerimaan-perbulan-preview') }}" method="get">
            @csrf
            <div class="field flex items-center gap-2">
        ...
        <hr>
        <form id="form-get-by-tahun" action="{{ url('/penerimaan-pertahun-preview') }}" method="get">
            @csrf
            <div class="field flex items-center gap-2">
